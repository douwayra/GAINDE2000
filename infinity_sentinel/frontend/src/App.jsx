    ...
    <div className={`app-container ${mobileMenuOpen ? 'sidebar-open' : ''}`}>
      ...
      <div className="mobile-navbar">
        ...
        <div className="mobile-logo">
          <img src="assets/infinity_logo.png" alt="Infinity Sentinel Logo" style={{ height: '36px', objectFit: 'contain' }} />
          <span>Infinity Sentinel</span>
        </div>
      ...
      <aside className={`sidebar ${mobileMenuOpen ? 'open' : ''}`}>
        <div className="sidebar-logo">
          <img src="assets/infinity_logo.png" alt="Infinity Sentinel Logo" />
          <div className="sidebar-logo-text">
            <h1>Infinity Sentinel</h1>
            {/* <p>saaytu business</p> */}
          </div>
        </div>
