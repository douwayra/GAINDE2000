...
# Query to fetch joined dossiers and articles for year 2026
query = """
    SELECT 
        d.NUMERODOSSIERTPS,
        d.DATEDOSSIERTPS,
    ...
    WHERE YEAR(d.DATEDOSSIERTPS) = 2026
    ORDER BY d.DATEDOSSIERTPS DESC
"""

output_path = "export_dossiers_2026.csv"
print("Extraction des données 2026 en cours...")
...
print(f"Export 2026 terminé avec succès ! Fichier écrit : {output_path} ({row_count} lignes exportées).")
